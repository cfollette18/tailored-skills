...
For interface work, pair this quality bar with the relevant frontend implementation skill in `07-software-development/frontend/` or the target product’s own component guidance.
