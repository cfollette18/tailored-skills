...
- Use the retained [restrained color guide](../../../03-anti-ai-slop/color/restrained-color-design/SKILL.md) and [motion quality guide](../../../03-anti-ai-slop/motion/motion-quality-review/SKILL.md) when those aspects need work. The visual reference below covers the relevant shell and motion values; do not impose a full redesign on a narrow request.
