...
These 13 dedicated skills were derived from the owner’s [Production AI Framework](https://github.com/cfollette18/production-ai-framework) at revision `feb7e5ca4df01bb722f8b83f6ff1962c276f2bd8`, reviewed 2026-09-21. They are organized across `01-software-development` and `04-tracing-observability`. The [expanded coverage map](../04-tracing-observability/coverage-map.md) adds complementary vendor-neutral workflows drawn from current primary documentation.
...
| [AI Evaluation and Release](../04-tracing-observability/evaluation/ai-evaluation-release/SKILL.md) | `docs/operating-framework.md`, `docs/pillars.md`, `templates/evaluation-case.json` |
| [AI Observability](../04-tracing-observability/tracing/ai-observability/SKILL.md) | `docs/pillars.md`, `docs/operating-framework.md`, `templates/trace.json` |
...
| [AI Release Governance](../04-tracing-observability/operations/ai-release-governance/SKILL.md) | `docs/operating-framework.md`, `docs/pillars.md`, `templates/change.json` |
| [AI Incident Response](../04-tracing-observability/operations/ai-incident-response/SKILL.md) | `docs/operating-framework.md`, `docs/multi-agent-orchestration.md`, `templates/incident.json` |
