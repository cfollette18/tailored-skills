...
For interface work, combine with `01-ui-design/baseline-ui`, `frontend-design`, or `impeccable` — this skill sets the **quality bar**; those skills set **implementation craft**.
