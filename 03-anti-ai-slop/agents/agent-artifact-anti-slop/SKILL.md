...
- `01-software-development/plan` — plan-mode constraints
- `01-software-development/hermes-agent-skill-authoring` — skill format
- `01-software-development/writing-plans` — plan structure
